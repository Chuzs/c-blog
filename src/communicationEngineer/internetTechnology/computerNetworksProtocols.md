...
1. 基本概念
  ...
  网络接口层：对实际的网络媒体进行管理，接收数据报并通过网络发送出去，或者从网络上接收数据帧，剥离出IP数据报，交给网络层
...
2. 与OSI/RM比较
  ...
  **不同点**：OSI/RM理论比较系统、全面，对具体实施有一定的指导意义，但与实际的实施还是有很大差别的，要完整实现所规定的所有功能是非常困难的；TCP/IP是在实践中逐步发展而来的，缺乏统一的规划，层次划分并不十分清晰和确定，在今后的发展过程中还会有所调整
